...
export const DashboardPage: React.FC = () => {
  ...
  const testApiConnection = async () => {
    ...
    try {
      ...
      setApiStatus(`✅ Conexão com API estabelecida! Dados recebidos: ${JSON.stringify(response)}`);
    } catch (error) {
      setApiStatus('❌ Erro na conexão com API. Verifique se o backend está rodando.');
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Sistema de Análise Comparativa de Resultados do ENEM
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500">Candidatos Analisados</p>
                <p className="text-2xl font-semibold text-gray-900">0</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <button className="w-full flex items-center justify-between p-3 text-left bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200">
                <div className="flex items-center">
                  ...
                  <span className="font-medium text-gray-900">Importar Dados ENEM</span>
                </div>
              ...
              <button className="w-full flex items-center justify-between p-3 text-left bg-green-50 hover:bg-green-100 rounded-lg transition-colors duration-200">
                <div className="flex items-center">
                  ...
                  <span className="font-medium text-gray-900">Gerar Relatório Comparativo</span>
                </div>
                <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              ...
              <button className="w-full flex items-center justify-between p-3 text-left bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors duration-200">
                <div className="flex items-center">
                  ...
                  <span className="font-medium text-gray-900">Visualizar Análises</span>
                </div>
                <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
          ...
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-400 mt-1">Comece importando dados do ENEM para ver análises</p>
          </div>
        </div>
      </div>
    </div>
